...
public class GunItem extends CoolModElements.ModElement {
	@ObjectHolder("cool:gun")
	public static final Item block = null;
	@ObjectHolder("cool:entitybulletgun")
	public static final EntityType arrow = null;
	public GunItem(CoolModElements instance) {
		super(instance, 13);
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			super(new Item.Properties().group(ProStuffItemGroup.tab).maxStackSize(3));
			setRegistryName("gun");
		}
			...
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					...
					if (entity.abilities.isCreativeMode || stack != ItemStack.EMPTY) {
						ArrowCustomEntity entityarrow = shoot(world, entity, random, 1f, 9.5, 10);
	...
	public static ArrowCustomEntity shoot(World world, LivingEntity entity, Random random, float power, double damage, int knockback) {
		...
		world.playSound((PlayerEntity) null, (double) x, (double) y, (double) z,
				(net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("cool:gun")), SoundCategory.PLAYERS, 1,
